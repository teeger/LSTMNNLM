#ifndef NNLM_RECURRENT_NNLM_H_
#define NNLM_RECURRENT_NNLM_H_
...
class RecurrentNeuralNetLM : public NeuralNetLMBase {

 public:
  // Constructors.
  RecurrentNeuralNetLM() : bptt_unfold_level_(1), num_hiddens_(0), 
    ngram_order_(0), hash_table_size_(0), hash_mode_(0) {}
  // Destructor.
  ~RecurrentNeuralNetLM() {}
