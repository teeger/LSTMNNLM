...
#include "nnlm/lp_recurrent_nnlm.h"
...
#define PROGRAM_NAME "Linear Projection + Recurrent Neural Network Langauge Model"
...
int main(int argc, char **argv) {
  ...
  config.add_options()
      ...
      // ("beta", po::value<float>(&beta)->default_value(0.0000001f),
      // "regularization parameter (disabled now as unstable for SGD)")
  ...
  nnlm::LPRecurrentNeuralNetLM recurrent_nnlm;
